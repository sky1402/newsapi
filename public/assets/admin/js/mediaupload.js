    ...
    if (files.length > 0) {
      ...
      try {
        ...
        var loader =
          ...
          baseURL +
          "assets/uploads/loader.gif' height='auto' width='100%'/></div>";
        $(".list-unstyled .col").prepend(loader);
        ...
        // Remove loader after prepending items
        $(".loader").remove();
      } catch (error) {
  ...
  $("#save_media_file").on("click", function () {
    ...
    $checkedLi.each(function () {
      ...
      var extension = fileName
        ...
        .toLowerCase(); // Ensure extension comparison is case insensitive
        ...
        if ($("#togetDownloadIcon").prop("checked")) {
          editor.selection.setContent(
            '<a href="' +
              ...
              '"><img src="' +
              baseURL +
              'assets/uploads/download.png" width="30px" height="30px"></a><br>'
          );
        } else {
          editor.selection.setContent(
            '<a href="' +
        ...
        if (response.uploaded_file && response.uploaded_file.length > 0) {
          ...
          $.each(response.uploaded_file, function (index, item) {
            ...
            if (
              ...
              html +=
                '<div class="position-relative d-flex flex-column"><img class="w-100 h-100" src="' +
                baseURL +
                'assets/uploads/pdf.png" alt=""><a class="doc position-absolute bottom-0 bg-light m-lib-a" href="' +
                baseURL +
                "assets/uploads/" +
                item.doc_temp_name +
                '">' +
